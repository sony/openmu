...
from .timm032.timm.models.vision_transformer import Block
from .util.pos_embed import (
    get_2d_sincos_pos_embed,
    get_2d_sincos_pos_embed_flexible,
)
from .util.patch_embed import PatchEmbed_new, PatchEmbed_org
from .timm032.timm.models.swin_transformer import SwinTransformerBlock
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder_no_mask(self, x):
        ...
        # x = self.norm(x)
        # print(len(contextual_embs), contextual_embs[-1].shape) 3 torch.Size([16, 513, 768])
