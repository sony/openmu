...
def get_args_parser():
    ...
    parser.add_argument(
        "--timem", help="time mask max length", type=int, default=0
    )  # pretraining 0
    parser.add_argument(
        "--mixup",
        type=float,
    ...
    parser.add_argument(
        "--alpha", type=float, default=0.0, help="contrastive loss weight"
    )
    parser.add_argument(
        "--omega", type=float, default=1.0, help="reconstruction loss weight"
    )
    parser.add_argument("--mode", default=0, type=int, help="contrastive mode")
    parser.add_argument(
        "--save_every_epoch", default=20, type=int, help="save_every_epoch"
    )
    parser.add_argument(
        "--use_custom_patch",
        type=bool,
    ...
    parser.add_argument(
        "--split_pos", type=bool, default=False, help="use splitted pos emb"
    )
    parser.add_argument(
        "--pos_trainable", type=bool, default=False, help="use trainable pos emb"
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="decoder mode 0: global attn 1: swined local attn",
    )
    # remove for A-MAE
    ...
    parser.add_argument(
        "--mask_t_prob", default=0.7, type=float, help="ratio of masking time"
    )
    parser.add_argument(
        "--mask_f_prob", default=0.3, type=float, help="ratio of masking freq"
    )
    parser.add_argument("--mask_2d", type=bool, default=False, help="use 2d masking")
    parser.add_argument(
        "--init_audio_with_video_mae",
        type=bool,
        default=False,
        help="init_audio_with_video_mae",
    )
