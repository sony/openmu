...
##########################################
# for modifying the inner training loop
# import transformers.integrations.tpu.tpu_spmd_dataloader as tpu_spmd_dataloader
                ...
                if (
                    ...
                    if args.max_grad_norm is not None and args.max_grad_norm > 0:
                        ...
                        if (
                            ...
                            grad_norm = (
                                _grad_norm.item() if _grad_norm is not None else None
                            )
                    # NOTE tracking global grad norm
                    # accelerate opt is wrapped ds optimizer
                    self.state._GLOBAL_STEP_NORM = grad_norm
